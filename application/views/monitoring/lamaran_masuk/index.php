  ...
  <body>
                      ...
                      <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                          ...
                          <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                              <label class="mb-3 top-label w-100">
                                <select class="select2TopLabel" id="filBulan" name="filBulan">
                          ...
                          <div class="row">
                            <div class="col-12 col-lg-12 col-md-12 col-sm-12">
                              <label class="mb-3 top-label w-100">
                                <select class="select2TopLabel" id="filNoRecruitment" name="filNoRecruitment">
                                    <option value="ALL">ALL</option>
                                </select>
    ...
    <script>
      $(document).ready(function(){
        ...
        $('#filNoRecruitment').on('change', function(){
          var filNoRecruitment = $(this).val();
          paging(0,filNoRecruitment)
        })
        ...
        $('#paging').on('click','.btnStep', function(){
          ...
          var filNoRecruitment = $('#filNoRecruitment').val();
          console.log(offset)
          paging(offset, filNoRecruitment)
          $('#inputOffset').val(offset)
        })
      ...
      function paging(offset, filNoRecruitment) {
