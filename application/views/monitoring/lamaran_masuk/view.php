            ...
            <div class="col">
              ...
              <div class="row">
                <div class="col-md-9">
                  ...
                  <?php endif ?>
                  <?php if ($data->test_id == null && $data->test_id_2 == null && $data->status == 'Aktif'): ?>
                    <section class="scroll-section">
                      <div class="row">
                        <div class="col-12 col-xl-3 col-lg-3 col-md-3 mb-5"></div>
                        <div class="col-12 col-xl-6 col-lg-6 col-md-6 mb-5">
                          <button type="button" class="btn btn-outline-primary active-scale-down w-100 btnStatus" data="<?=$data->id?>" status="NG"><i data-acorn-icon="arrow-double-right"></i>Klik untuk status lamaran menjadi NG<i data-acorn-icon="arrow-double-left"></i></button>
                        </div>
                      </div>
                    </section>
