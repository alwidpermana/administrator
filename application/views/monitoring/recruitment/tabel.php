    ...
    <tbody>
        ...
        <?php else: ?>
            <?php foreach ($data as $key): ?>
                <tr>
                    <td><?=$startNo++?></td>
                    <td><a class="btn btn-sm btn-icon btn-icon-start btn-outline-primary ms-1" href="<?=base_url()?>monitoring/view_setup/<?=$key->id?>">Lihat</a></td>
                    ...
                    <td><?=$key->lulus_pria?></td>
                    <td><?=$key->lulus_wanita?></td>
                    <td><?=$key->lulus_total?></td>
                    <td><?=$key->outstanding_pria?></td>
                    <td><?=$key->outstanding_wanita?></td>
                    <td><?=$key->outstanding_total?></td>
                    <td><?=$key->status?></td>
                </tr>            
            <?php endforeach ?>    
        <?php endif ?>
