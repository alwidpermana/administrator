  ...
  <body>
                    ...
                    <div class="d-inline-block me-0 me-sm-3 float-start float-md-none">
                      ...
                      <div class="dropdown-as-select d-inline-block datatable-length" data-datatable="#datatableRows" data-childSelector="span">
                        ...
                        <div class="dropdown-menu shadow dropdown-menu-end">
                          <a class="dropdown-item ubahTahap active" href="javascript:;" data="">ALL</a>
                          <a class="dropdown-item ubahTahap" href="javascript:;" data="1">Tahap 1</a>
                          <a class="dropdown-item ubahTahap" href="javascript:;" data="2">Tahap 2</a>
                        </div>
                        <input type="hidden" id="filTahap" value="">
                        <input type="hidden" id="filTahap2" value="">
                      </div>
                      <div class="dropdown-as-select d-inline-block datatable-length" data-datatable="#datatableRows" data-childSelector="span">
                        <button class="btn p-0 shadow" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-bs-offset="0,3">
                          <span
            ...
            <form id="formSave">
              ...
              <div class="modal-body">
                ...
                <div class="row nonOperator d-none">
                  <div class="col-12">
                    <div class="form-floating mb-2">
                      <input type="text" class="date-picker form-control datePickerFloatingLabel" placeholder="Date" name="inputTglTes2" id="inputTglTes2" onchange="getNoTes()" />
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        $('.ubahTahap').on('click', function(){
          var tahap = $(this).attr("data")
          $('#filTahap').val(tahap);
          tableData.ajax.reload();
          tablePelamar.ajax.reload();
          tablePeserta.ajax.reload();
          $('#cardPelamar').addClass("d-none");
        })
      ...
      function getNoTes() {
        ...
        var inputTglTes = $('#inputTglTes').val();
        var inputTglTes1 = $('#inputTglTes1').val();
        var inputTahap = $('#inputTahap').val();
        $.ajax({
          type:'get',
          data:{inputPlant, inputTglTes, inputTglTes1, inputTahap},
          dataType:'json',
          cache:false,
          async:true,
