                      ...
                      <div class="col-auto ">
                        <div class="card hover-border-primary sw-19 sh-30">
                          <div class="h-100 d-flex flex-column justify-content-between card-body align-items-center">
                            ...
                            <div class="display-5 text-primary" id="jmlPeserta">0</div>
                          </div>
                        </div>
                      </div>
                      <div class="col-auto">
                        <div class="card hover-border-primary sw-19 sh-30">
                          <div class="h-100 d-flex flex-column justify-content-between card-body align-items-center">
                            ...
                            <div class="display-5 text-primary" id="jmlLulus">0</div>
                          </div>
                        </div>
                      </div>
                      <div class="col-auto">
                        <div class="card hover-border-primary sw-19 sh-30">
                          <div class="h-100 d-flex flex-column justify-content-between card-body align-items-center">
                            ...
                            <div class="display-5 text-primary" id="jmlTidakLulus">0</div>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <table id="listPeserta" class="data-table nowrap hover text-center">
                    <thead>
                      <tr>
                        ...
                        <th class="text-muted text-small text-uppercase" rowspan="2"></th>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        $('#searchPeserta').on('keyup', function(){
          tabelPeserta.search( this.value ).draw();
        }) 
      })
      function getCount(id) {
        $.ajax({
          ...
          cache:false,
          async:true,
          url:'getTotalJmlPeserta',
          success:function(data){
            $('#jmlPeserta').html(data.jmlPeserta);
            $('#jmlLulus').html(data.jmlLulus);
            $('#jmlTidakLulus').html(data.jmlTidakLulus);
          },
          error:function(data){
