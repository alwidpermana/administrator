                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                      <div class="row mt-3">
                        <form id="submitData"> 
                          <div class="col-md-12">
                            <section class="scroll-section" id="referensiData">
                              <div class="card mb-5">
                                <div class="card-header">
                                  <div class="card-title">Referensi Data</div>
                                </div>
                                <div class="card-body">
                                  <div class="row">
                                    <div class="col-md-6">
                                      <div class="row">
                                        <div class="col-md-12">
                                          <div class="form-floating mb-2">
                                            <input type="text" class="form-control" placeholder="NIK Referensi" value="" name="inputReferensiNIK"/>
                                                <label>NIK <span class="text-primary">*</span></label>
                                          </div>
                                        </div>
                                      </div>
                                      <div class="row">
                                        <div class="col-md-12">
                                          <div class="form-floating mb-2">
                                            <input type="text" class="form-control" placeholder="Nama Referensi" value="" name="inputReferensiNama"/>
                                                <label>Nama <span class="text-primary">*</span></label>
                                          </div>
                                        </div>
                                      </div>
                                      <div class="row">
                                        <div class="col-md-12">
                                          <div class="form-floating mb-2">
                                            <input type="text" class="form-control" placeholder="Jabatan Referensi" value="" name="inputReferensiJabatan"/>
                                                <label>Jabatan <span class="text-primary">*</span></label>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                                    <div class="col-md-6">
                                      <div class="row">
                                        <div class="col-md-12">
                                          <div class="form-floating mb-2">
                                            <input type="text" class="form-control" placeholder="Departemen Referensi" value="" name="inputReferensiDepartemen"/>
                                                <label>Departemen <span class="text-primary">*</span></label>
                                          </div>
                                        </div>
                                      </div>
                                      <div class="row">
                                        <div class="col-md-12">
                                          <div class="form-floating mb-2">
                                            <input type="text" class="form-control" placeholder="Sub Departemen Referensi" value="" name="inputReferensiSubDepartemen"/>
                                                <label>Sub Departemen <span class="text-primary">*</span></label>
                                          </div>
                                        </div>
                                      </div>
                                      <div class="row">
                                        <div class="col-md-12">
                                          <div class="form-floating mb-2">
                                            <input type="text" class="form-control" placeholder="Hubungan Referensi" value="" name="inputReferensiHubungan"/>
                                                <label>Hubungan <span class="text-primary">*</span></label>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                  ...
                  <div class="col-md-auto d-none d-lg-block" id="scrollSpyMenu">
                    <ul class="nav flex-column">
                      <li>
                        <a class="nav-link" href="#referensiData">
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        $('#submitData').submit(function(e){
          e.preventDefault();
          $.ajax({
            url:base_url+'data_master/addData',
            type:"post",
            dataType:'json',
