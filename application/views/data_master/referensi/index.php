              ...
              <div class="page-title-container">
                <div class="row">
                  ...
                  <div class="col-12 col-md-5 d-flex align-items-start justify-content-end">
                    ...
                    <a href="<?=base_url()?>data_master/add_referensi" class="btn btn-outline-primary btn-icon btn-icon-start w-100 w-md-auto">
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        var tableData =  $('#pelamarTabel').DataTable({
          ...
          "order": [[0, "asc"]],
          "ajax": {
              url: base_url + 'data_master/getDataPelamar',
              type: 'POST',
              "data": function(d){
