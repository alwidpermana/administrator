          ...
          <div class="col-12 col-lg-auto h-100 pb-4 px-4 pt-0 p-lg-0">
            <div class="sw-lg-80 min-h-100 bg-foreground d-flex justify-content-center align-items-center shadow-deep py-5 full-page-content-right-border">
              <div class="sw-lg-60 px-5">
                ...
                <div class="mb-5">
                  <h2 class="cta-1 mb-0 text-primary">Link verifikasi sudah dikirim ke email anda</h2>
                </div>
                <div class="mb-5">
                  <p class="h6">Segera lakukan verifikasi untuk melakukan login</p>
                  <p class="h6">
                    Jika terdapat kesalahan mohon hubungi 
                    <a href="index.html">kami</a>
                  </p>
                </div>
                <div>
                  <a href="index.html" class="btn btn-icon btn-icon-start btn-primary">
