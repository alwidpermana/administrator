  ...
  <body>
    ...
    <script type="text/javascript">
      ...
      function paging(offset) {
        ...
        $.ajax({
          type:'get',
          data:{filTahun, filBulan, limit,offset, filSearch, filJenis, filSub, filType, filStatus},
          cache:true,
          async:true,
          url:base_url+'bank_data/getPaging',
          success:function(data){
            $('#paging').html(data)
            getTabel(filTahun, filBulan, limit,offset, filSearch, filJenis, filSub, filType, filStatus)
          },
          error:function(data){
      ...
      function getTabel(filTahun, filBulan, limit,offset, filSearch, filJenis, filSub, filType, filStatus) {
        $.ajax({
          type:'get',
          data:{filTahun, filBulan, limit,offset, filSearch, filJenis, filSub, filType, filStatus},
          cache:true,
          false:true,
          url:base_url+'bank_data/getData',
